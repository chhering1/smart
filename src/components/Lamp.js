...
const Lamp = ( {bgColor}) => {
  const {opacity} = useContext(dataContext)
const lamp = css`
...
`;
    ...
    return ( 
        // <div className={style}>
<svg  width="139" height="192" viewBox="0 0 139 192"css={lamp} className="lamp animate__animated animate__fadeInDown animate__delay-1s">
  <defs>
  ...
  <g id="light_bulb" data-name="light bulb" transform="translate(-204 4)">
    ...
    <g transform="matrix(1, 0, 0, 1, 204, -4)" filter="url(#Ellipse_10)">
      <circle id="Ellipse_10-2" data-name="Ellipse 10" cx="11" cy="11" r="11" transform="translate(59 143)" fill={bgColor} opacity={opacity/100}/>
    </g>
